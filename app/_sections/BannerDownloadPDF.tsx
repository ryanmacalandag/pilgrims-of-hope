...
export default function BannerDownloadPDF() {
  return (
    <section className="py-0">
      <div className="group relative w-full max-w-screen-xl mx-auto px-0 sm:px-12 overflow-hidden">
        ...
        <div className="absolute z-0 bottom-4 -right-16 sm:right-8 md:right-20 xl:right-40 scale-90 sm:scale-100 flex group-hover:rotate-6 group-hover:-translate-y-8 transition duration-300">
          <Image
