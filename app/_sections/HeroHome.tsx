...
export default function HeroHome() {
  return (
    <section id='home' className='w-full'>
      <div className='w-full h-full min-h-dvh max-w-screen-lg mx-auto flex flex-col gap-6 justify-center items-center px-6 py-12'>
        ...
        <div>
          <Link href='/sites' className='text-xs md:text-base font-sans font-bold uppercase tracking-widest border-2 border-stone-400/40 hover:border-teal-800 hover:bg-teal-800 hover:text-white rounded-full px-6 py-4 transition duration-300'>
            View Sites
          </Link>
        </div>
      </div>
