      ...
      <div className='grid grid-cols-12 gap-4'>
        <div className='col-span-12 md:col-span-5 mb-6'>
          <div className='flex flex-col gap-6 pl-0 md:pl-0'>
            ...
            <p>Here is a list of the most common customer questions. If you can&#39;t find an answer to your question, please don&#39;t hesitate to reach out to us.</p>
            <p className='flex gap-3'>
              <span className='font-bold'>Need help? </span>
              <Link
                href='/support'
                className='text-orange-500 hover:text-orange-800 flex flex-row gap-1 items-center transition duration-300'
              >
                Contact support
        ...
        <div className='col-span-12 md:col-span-7'>
          <div className='grid grid-cols-12 gap-4'>
            <div className='col-span-12'>
              <Checkbox className='group flex flex-col gap-2 lg:gap-4 border-b border-stone-300'>
