...
export default function HomeHero() {
  return (
    <section className="relative w-full">
      <div className="w-full max-w-screen-xl mx-auto grid grid-cols-12 gap-4 px-6 sm:px-12 pt-8 md:pt-12 xl:pt-20">
        <div className="col-span-12 md:col-span-12 flex flex-col gap-2 md:gap-4">
          <div className="text-xxs md:text-xs lg:text-xs uppercase tracking-widest text-stone-600 text-left sm:text-center mt-4">
            Jubilee Resources
          </div>
          ...
          <p className="w-full lg:max-w-screen-md mx-auto text-left sm:text-center text-base sm:text-md text-balance">
