...
export default function SocialShareButtons() {
  return (
    <div className='w-full max-w-screen-xl mx-auto my-12 flex flex-wrap gap-3 pr-6 pl-12'>
      <Link
        href={'https://www.facebook.com/sharer.php?u=https%3A%2F%2Fpilgrims-of-hope.vercel.app%2Fsites%2Fst-christophers-cathedral'}
        target='_blank'
      ...
      >
        <BiLogoFacebook size={20} className='w-fit h-fit px-4 py-5 bg-blue-900/40'></BiLogoFacebook>
        Share on Facebook
      </Link>
      <Link
        href={'https://www.linkedin.com/shareArticle?url=https%3A%2F%2Fpilgrims-of-hope.vercel.app%2Fsites%2Fst-christophers-cathedral&title=St%20Christopher%27s%20Cathedral'}
        target='_blank'
